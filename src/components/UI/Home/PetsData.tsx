  ...
  return (
    <div>
      <div className=" pt-28 text-black">
        ...
        {!isLoading && data?.data && (
          <div className="grid grid-cols-1 gap-4 md:grid-rows-2 lg:grid-cols-3 xl:grid-cols-4 px-10 sm:px-14">
      ...
      <div className=" text-center mx-auto mb-4">
        <Link href={"/allpets"}>
          <Button sx={{ border: "1px solid blue" }}>View All Pets Data</Button>
        </Link>
      </div>
    </div>
  );
